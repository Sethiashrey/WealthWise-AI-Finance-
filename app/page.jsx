import HeroSSection from "@/components/hero";
    ...
    <div className="mt-40">
            ...
            {featuresData.map((feature, index) => (
              <Card key={index} className="p-6">
                <CardContent className="space-y-4 pt-4">
                  <h3 className="text-ul font-semihold">{feature.icon}</h3>
      ...
      <section className="py-20 bg-blue-600">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-blue-100 mb-8 max-w-2xl mx-auto">Join Thousands of users who are already managing their finances smarter with Wealthwise AI</p>
          <Link href="/dashboard">
